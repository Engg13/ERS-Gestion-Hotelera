...
const hotels = [
  {
    ...
    description: 'Elegancia y modernidad en el corazón de la capital',
  },
  {
    id: 2,
    name: 'Grand Hotel Valparaíso',
    city: 'Valparaíso',
    rating: 5,
    ...
    description: 'Lujo frente al océano Pacífico con vistas espectaculares',
  },
  {
    id: 3,
    name: 'Grand Hotel Viña del Mar',
    city: 'Viña del Mar',
    rating: 5,
    ...
    description: 'Resort de lujo en la ciudad jardín junto al mar',
  },
  {
    id: 4,
    name: 'Grand Hotel Concepción',
    city: 'Concepción',
    rating: 5,
    ...
    description: 'Confort y estilo en el corazón del sur de Chile',
  },
  {
    id: 5,
    name: 'Grand Hotel La Serena',
    city: 'La Serena',
    rating: 5,
    ...
    description: 'Esplendor bajo los cielos del Valle del Elqui',
  },
  {
    id: 6,
    name: 'Grand Hotel Puerto Varas',
    city: 'Puerto Varas',
    rating: 5,
    ...
    description: 'Encanto alpino frente al lago Llanquihue',
  },
];
